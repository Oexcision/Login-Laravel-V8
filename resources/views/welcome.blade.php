                ...
                <div class="form login">
                    <div class="form-content">
                        ...
                        <form method="POST" action="{{ route('login') }}">
                            ...
                            <div class="field input-field text-center">
                                <div class="form-check d-flex flex-column align-items-center">
                                    <label class="form-check-label" for="remember">
                                        {{ __('Remember Me') }}
                                    </label>
                                    <input class="form-check-input mt-auto" type="checkbox" name="remember" id="remember" {{ old('remember') ? 'checked' : '' }}>
                                </div>
                            </div>
                        ...
                        <div class="form-link">
                            <span>¿No tienes una cuenta aún? <a href="#" class="link signup-link">Signup</a></span>
                        </div>
                    </div>
                ...
                <div class="form signup">
                    <div class="form-content">
                        ...
                        <form method="POST" action="{{ route('register') }}">
                            ...
                            <div class="field input-field">
                                <input id="password" type="password" class="form-control @error('password') is-invalid @enderror" name="password" required autocomplete="new-password" placeholder="Crear Contraseña" >
                            </div>
                            <div class="field input-field">
